...
public class FinalBossIntroScene implements Scene {
  ...
  public void handleEvent(GameEvent event, Player player, Enemy _enemy) {
    switch (event) {
      case HOLE -> {
        System.out.println(
                "In an act of pure desperation you roll towards the hole and successfully drop in.\n" +
                        "----------------------------------------\n" +
      ...
      case CREW -> {
        _sceneState.setStory(
                "You drop to the floor and log over to your crew.\n" +
      ...
      case READY -> {
        System.out.print(
                "Saving your crew crosses your mind,\n" +
