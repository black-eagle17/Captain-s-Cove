...
public class ShipScene implements Scene{
    ...
    public void handleEvent(GameEvent event, Player player) {
        switch (event){
            ...
            case INVESTIGATE ->{
                System.out.println("You take the Amulet and see it glow. \n" +
            ...
            case EAT ->{
                System.out.println("Its old fish… you feel a sickly rumble in your stomach and your body begins to feel weak.\n" +
